...
import './TypeClothes.scss';
import { arraySection } from '../../arraysDate';
function TypeClothes({ search, searchText, typeClothes, setTypeClothes, setSearchText }) {
  ...
  return (
    <div style={{ marginLeft: 20 }}>
      <div className="d-flex justify-between">
        <ul style={{ height: 'fit-content' }} className="d-flex justify-between">
          <li
            onClick={() => setTypeClothes('all')}
            className={
              typeClothes === 'all'
                ? 'titleTypeClothes titleTypeClothesActive'
                : 'titleTypeClothes '
            }>
            Всё
          </li>
          <li
            onClick={() => setTypeClothes('top')}
            className={
              typeClothes === 'top'
                ? 'titleTypeClothes titleTypeClothesActive'
                : 'titleTypeClothes '
