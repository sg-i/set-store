...
import ControlTableItem from './ControlTableItem';
const ControlTable = ({ ageType, typeClothes, genderType, searchText }) => {
  ...
  return (
    <div>
      <table className="tableControl">
        <tr>
          <th className=" align-center cu-p" style={{ border: 'none' }} onClick={sortByName}>
            Название
            <svg
		...
		L12.703,4.285z"
          ...
          <th>Фото</th>
          <th className=" align-center  cu-p" style={{ border: 'none' }} onClick={sortByType}>
            Тип
            <svg
              style={{ marginTop: 2, marginLeft: 2 }}
              height="13"
		...
		L12.703,4.285z"
          ...
          <th>Описание</th>
          <th className=" align-center  cu-p" style={{ border: 'none' }} onClick={sortByPrice}>
            Цена
            <svg
              style={{ marginTop: 2, marginLeft: 2 }}
              height="13"
		...
		L12.703,4.285z"
          ...
          <th>Дизайнер</th>
          <th>Размеры</th>
          <th className="  align-center cu-p" style={{ border: 'none' }} onClick={sortByColor}>
            Цвет
            <svg
              style={{ marginTop: 2, marginLeft: 2 }}
              height="13"
		...
		L12.703,4.285z"
          ...
          <th className=" align-center cu-p" onClick={sortByViews}>
            Views
            <svg
              style={{ marginTop: 2, marginLeft: 2 }}
              height="13"
