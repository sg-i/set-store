...
import ControlHeaderItem from '../ControlHeaderItem';
function ControlHeader({ section, setSection, setAuthState }) {
  function ButtonLogOut() {
    console.log('pput was logout');
    axios
      .get('/logout')
      .then(() => {
  ...
  const arraySection = ['Список товаров', 'Добавить товар', 'Новая коллекция'];
  return (
    <div className="wrapControl">
      ...
      <div className="sectionControl">
        {arraySection.map((el) => (
          <ControlHeaderItem el={el} section={section} setSection={setSection} />
        ))}
      </div>
      <div className="logOutControlWrap">
        <div onClick={ButtonLogOut} className="logOutControl">
          Выход
        </div>
      </div>
    </div>
