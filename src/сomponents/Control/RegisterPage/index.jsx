...
function RegisterPage() {
  ...
  return (
    <div dangerouslySetInnerHTML={createMarkup(state)} />
    ...
    //         <input name="username" className="inputControlAuth" placeholder="login" type="text" />
    //       </div>
    //       <div className="inputDiv">
    //         <input
    //           type="password"
    ...
    //         {/* <div className="buttonAuthLogin">Войти</div> */}
    //       </div>
    //     </form>{' '}
    //   </div>
    // </div>
